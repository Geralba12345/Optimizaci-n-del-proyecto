...
//Acá pasé un condicional if a un operador ternario
...
let modoRojo
//Acá también pasé un condicional if a un operador ternario
...
//Desestructuré un objeto
const {nombre,equipo} = jug1
console.log(nombre)
console.log(equipo)

//Desestructuré un objeto y le cambié el alias
const {nombre:player, equipo:team, posición:position} = jug4
console.log(player)
console.log(team)
console.log(position)

//Desestructuré el array
let [a,b,c] = destacados
console.log(a)
console.log(b)
console.log(c)

//Utilicé spread para agregar nuevo valores
